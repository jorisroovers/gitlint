...
CC2   | contrib-disallow-fixup-squash       | >= 0.18.0         | Commit title must not contain `fixup!` or `squash!`.
...
## CC2: contrib-disallow-fixup-squash ##

ID    | Name                          | gitlint version    | Description
------|-------------------------------|--------------------|-------------------------------------------
CC2   | contrib-disallow-fixup-squash | >= 0.18.0          | Commit title must not contain `fixup!` or `squash!`. This means `git commit --fixup` and `git commit --squash` commits are not allowed.
