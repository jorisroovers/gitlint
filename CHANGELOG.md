...
## Features
  ...
  - Gitlint now seperates `FILE_ENCODING` (always UTF-8) from `TERMINAL_ENCODING` (terminal dependent), this should improve issues with unicode. Use `gitlint --debug` to inspect these values. ([#424](https://github.com/jorisroovers/gitlint/issues/424))
...
## Development
  ...
  - Gitlint now publishes [dev builds on every commit to main](https://jorisroovers.github.io/gitlint/contributing/#dev-builds)
  - Gitlint now publishes a `latest_dev' docker image on every commit to main ([#451](https://github.com/jorisroovers/gitlint/issues/452)) ([#452](https://github.com/jorisroovers/gitlint/issues/451))
  ...
  - Integration test fixes on windows ([#397](https://github.com/jorisroovers/gitlint/issues/397))
  ...
  - Fix most integration tests on Windows ([#392](https://github.com/jorisroovers/gitlint/issues/392))
